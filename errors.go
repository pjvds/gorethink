...
const (
	...
	RQLNonExistenceError              = "NON_EXISTENCE"
	RQLResourceLimitError             = "RESOURCE_LIMIT"
	RQLUserError                      = "USER"
	RQLInternalError                  = "INTERNAL"
	RQLOpFailedError                  = "OP_FAILED"
	RQLOpIndeterminateError           = "OP_INDETERMINATE"
	RQLUnknownRuntimeError            = "RUNTIME"
)
